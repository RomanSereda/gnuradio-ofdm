...
class ofdm_loopback_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pilot_carriers = pilot_carriers = ((-9,-3,3,9),)
        self.packet_len = packet_len = 64
        self.occupied_carriers = occupied_carriers = ((-8,-6,-4,-2,-1,1,2,4,6,8),)
        ...
        self.soapy_hackrf_source_0 = soapy.source(dev, "fc32", 1, 'driver=remote,remote=tcp://192.168.128.210:55132,remote:driver=hackrf',
                                  stream_args, tune_args, settings)
        self.soapy_hackrf_source_0.set_sample_rate(0, samp_rate)
        self.soapy_hackrf_source_0.set_bandwidth(0, 2000000)
        self.soapy_hackrf_source_0.set_frequency(0, 776000000)
        ...
        self.pdu_tagged_stream_to_pdu_0 = pdu.tagged_stream_to_pdu(gr.types.byte_t, 'rx_len')
        ...
        self.iio_pluto_sink_0.set_frequency(776000000)
        self.iio_pluto_sink_0.set_samplerate(samp_rate)
        self.iio_pluto_sink_0.set_attenuation(0, 12)
        ...
        self.digital_ofdm_rx_0 = digital.ofdm_rx(
            ...
            debug_log=False,
            scramble_bits=True)
        self.blocks_vector_source_x_0 = blocks.vector_source_b(list(map(ord, list('qwertyuiopasdfghjklzxcvbnm123456qwertyuiopasdfghjklzxcvbnm123456'))), True, 1, ())
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.iio_pluto_sink_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.soapy_hackrf_source_0, 0), (self.digital_ofdm_rx_0, 0))
